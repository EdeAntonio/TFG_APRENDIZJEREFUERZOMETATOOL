...
Reinforcement Learning for Robotic Manipulation Tasks"} \cite{sim2realpaper} se realiza un estudio de estos distintos tipos de entrenamiento. El que mejor resultado obtiene es el aprendizaje con aleatorización  del dominio, seguido por \emph{fine-tunning}. Debido a ser el mejor modo y tener tiempo limitado para el entrenamiento, se escoge esta opción para enfocar el Sim2Real.
