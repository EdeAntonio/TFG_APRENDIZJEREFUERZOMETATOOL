...
Cabe destacar que las aportaciones de Markov incluyen más tipos de procesos, como las cadenas de Markov o los Procesos de Recompensa Markov \cite[Lección 2]{silver_lectures_nodate}. Estos son casos particulares de MDPs, por lo que no se estudiarán en este trabajo. Sin embargo, si se prefiere entender gradualmente los conceptos de estados y sus transiciones, es recomendable trabajarlos.
...
En el estado tres (figura \ref{fig:Estado3}), podemos ver un ejemplo de falta de acciones. Si se considerar como un proceso individual, se debería definir como un Proceso de Recompensa Markov. Por otro lado, si no tuviésemos en cuenta las recompensas, se podría definir como una Cadena de Markov.
