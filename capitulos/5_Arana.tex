...
Con vistas a los futuros proyectos dentro de la ETSIDI se van a proponer e integrar dos principales mejoras. Estas se introducirán en este trabajo, pero su expansión e implementación final se darán en futuros trabajos. La primera de ellas será cambiar el terreno donde se entrena la locomoción. En el ejercicio realizado, el terreno es completamente plano, algo poco usual en el mundo real. La segunda mejora a integrar es el uso de cámaras. Estas podrán a ayudar a evitar obstáculos o mejorar la locomoción en terrenos irregulares.
