...
% Iclusión de paquetes básicos
\usepackage[utf8]{inputenc} % Paquete para lectura de acentos y simbolos.
\usepackage[T1]{fontenc} % Paquete para exportar a PDF
\usepackage[spanish]{babel} % Cambia el idioma al español
\usepackage{graphicx} % Paqueta para la inserción de imagenes
...
\onehalfspacing % Interlineado de 1.5
    ...
    % Sangría y espacio entre parrafos
\setlength{\parindent}{1.25cm}
\setlength{\parskip}{0.2cm}

\includeonly{capitulos/2_EstadoArte}
